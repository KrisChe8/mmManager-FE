...
function Analysis() {
    const [activeClassExpensesA, setActiveClassExpensesA] = useState('homebtn_active');
    ...
    <section>
            ...
            <Link className="switcherLink" to="/analysis">
                <div className= {`addExpenses homebtn ${activeClassExpensesA}`}  onClick = {changeExpensesClass}>
                    <p className="btn-name"> Expenses</p> 
                </div></Link>
                <Link className="switcherLink" to="/analysis/income-analysis">
                <div className={`addIncome homebtn ${activeClassIncomeA}`} onClick = {changeIncomeClass}>

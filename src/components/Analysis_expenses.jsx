    ...
    <section>
      <div className="analysis-wrapper">
        <div className="switcher-time">
            <div className={`switcher-time-item  ${todayClass}`} onClick={switchTodayClass}>
            <Link className="switcher-link " to='/analysis/today'> Today</Link>
            </div>
            <div className={`switcher-time-item ${weekClass}`} onClick={switchWeekClass}>
            <Link className="switcher-link" to='/analysis/week'> Week </Link>
            </div>
            {/* <div className="switcher-time-item">
            <Link className="switcher-link" to=''> 10 days</Link>
            </div> */}
            <div className={`switcher-time-item ${monthClass}`} onClick={switchMonthClass}>
            <Link className="switcher-link" to='/analysis/month'> Month</Link>
            </div>
            <div className={`switcher-time-item ${yearClass}`} onClick={switchYearClass}>
            <Link className="switcher-link" to='/analysis/year'> Year</Link>  
            </div>
        </div>
        <Routes>
